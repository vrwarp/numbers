 ...
 * (wheel, pinch, drag, double-tap, buttons); PDFs use the browser's own
 * zoomable viewer. Zoom math keeps the point under the cursor/pinch-midpoint
 * fixed, treating the container centre as the transform origin.
 */
